		...
		<?php
			if(isset($_POST['register']))
			{
				...
				$ndate=$_POST['ndate'];
					...
					$sql = "select * from personal where aadhar='$aadhar'";
					...
					{
						$sql = "insert into information values('$aadhar','$allergy','$bp','$diabetes','$doctoer','$dov','$hospital','$visit','$suggetion','$medication','$prescription','$ndate')";
						$result = $conn->query($sql);
