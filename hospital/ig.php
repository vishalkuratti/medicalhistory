      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li class="active"><a href="ig.php"><i class="fa fa-home" aria-hidden="true"></i> Home</a></li>       
			...
			<li><li><a href="logout.php" class="btn btn-warning btn-md"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li></li>
          </ul>
        </div><!--/.nav-collapse -->
